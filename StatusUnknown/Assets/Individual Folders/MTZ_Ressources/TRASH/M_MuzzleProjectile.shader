	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				Gradient gradient27 = NewGradient( 0, 3, 2, float4( 0.6792453, 0.2197243, 0, 0 ), float4( 1, 0.7731253, 0, 0.4911726 ), float4( 0.6736857, 1, 0.05098039, 1 ), 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				...
				float smoothstepResult32 = smoothstep( 0.0 , _OpacityCap , tex2DNode8.r);
				
				surfaceDescription.Color = ( _EmissiveIntensity * SampleGradient( gradient27, ( _ColorDarken * tex2DNode8.r ) ) ).rgb;
...
Node;AmplifyShaderEditor.GradientNode;60;-1056,-240;Inherit;False;0;3;2;0.06666666,0.3764706,0.1131507,0;0,0.6898999,0.6981132,0.6;0.05098039,0.9357048,1,1;1,0;1,1;0;1;OBJECT;0
...
ASEEND*/
//CHKSM=F92357F5CCA0DEEE6477D489BFBADD495B3569A3