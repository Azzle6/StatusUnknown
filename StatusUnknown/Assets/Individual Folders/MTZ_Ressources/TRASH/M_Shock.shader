...
Shader "M_MuzzleProjectile"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		_PackTex("PackTex", 2D) = "white" {}
		_Index("Index", Float) = 0
		_EmissiveIntensity("EmissiveIntensity", Float) = 20
		_OpacityPower("OpacityPower", Float) = 1
		_OpacityCap("OpacityCap", Float) = 1
		_ColorDarken("ColorDarken", Range( 0 , 1)) = 1
	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				Gradient gradient60 = NewGradient( 0, 3, 2, float4( 0.2240418, 0.1053756, 0.6037736, 0 ), float4( 0.252759, 0.2867901, 0.754717, 0.4911726 ), float4( 1, 0.2328192, 0, 1 ), 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				...
				float2 temp_output_15_0_g1 = ( ( packedInput.ase_texcoord1.xy / appendResult7_g1 ) + ( floor( ( appendResult8_g1 * appendResult29_g1 ) ) / appendResult7_g1 ) );
				float4 tex2DNode8 = tex2D( _PackTex, temp_output_15_0_g1 );
				
				float smoothstepResult32 = smoothstep( 0.0 , _OpacityCap , tex2DNode8.b);
				
				surfaceDescription.Color = ( _EmissiveIntensity * SampleGradient( gradient60, ( _ColorDarken * tex2DNode8.b ) ) ).rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = pow( smoothstepResult32 , _OpacityPower );
		...
		Pass
		{
					...
					)
			{
				...
				float temp_output_35_0_g1 = frac( ( ( 0.0 + clampResult42_g1 ) / totalFrames39_g1 ) );
				float2 appendResult29_g1 = (float2(temp_output_35_0_g1 , ( 1.0 - temp_output_35_0_g1 )));
				float2 temp_output_15_0_g1 = ( ( packedInput.ase_texcoord.xy / appendResult7_g1 ) + ( floor( ( appendResult8_g1 * appendResult29_g1 ) ) / appendResult7_g1 ) );
				float4 tex2DNode8 = tex2D( _PackTex, temp_output_15_0_g1 );
				float smoothstepResult32 = smoothstep( 0.0 , _OpacityCap , tex2DNode8.b);
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float temp_output_35_0_g1 = frac( ( ( 0.0 + clampResult42_g1 ) / totalFrames39_g1 ) );
				float2 appendResult29_g1 = (float2(temp_output_35_0_g1 , ( 1.0 - temp_output_35_0_g1 )));
				float2 temp_output_15_0_g1 = ( ( packedInput.ase_texcoord2.xy / appendResult7_g1 ) + ( floor( ( appendResult8_g1 * appendResult29_g1 ) ) / appendResult7_g1 ) );
				float4 tex2DNode8 = tex2D( _PackTex, temp_output_15_0_g1 );
		...
		Pass
		{
					...
					)
			{
				...
				float temp_output_35_0_g1 = frac( ( ( 0.0 + clampResult42_g1 ) / totalFrames39_g1 ) );
				float2 appendResult29_g1 = (float2(temp_output_35_0_g1 , ( 1.0 - temp_output_35_0_g1 )));
				float2 temp_output_15_0_g1 = ( ( packedInput.ase_texcoord3.xy / appendResult7_g1 ) + ( floor( ( appendResult8_g1 * appendResult29_g1 ) ) / appendResult7_g1 ) );
				float4 tex2DNode8 = tex2D( _PackTex, temp_output_15_0_g1 );
				float smoothstepResult32 = smoothstep( 0.0 , _OpacityCap , tex2DNode8.b);
...
Node;AmplifyShaderEditor.RangedFloatNode;25;-1419.786,-924.7892;Inherit;False;Property;_MuzzleProjectile;Muzzle/Projectile;3;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;46;-3616.795,-730.3943;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;43;-3424.795,-618.3943;Inherit;False;Property;_Purple;Purple;6;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;47;-3280.795,-730.3943;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;28;-3760.795,-618.3943;Inherit;False;Property;_Blue;Blue;8;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;48;-2944.795,-730.3943;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;44;-3088.795,-618.3943;Inherit;False;Property;_Pink;Pink;7;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GradientNode;38;-2816.795,-682.3943;Inherit;False;0;3;2;0.6784314,0.05619364,0,0;1,0,0.1665177,0.3617609;0.9726493,1,0,1;1,0;1,1;0;1;OBJECT;0
Node;AmplifyShaderEditor.LerpOp;49;-2608.795,-730.3943;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;41;-2752.795,-618.3943;Inherit;False;Property;_Red;Red;11;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;50;-2272.795,-730.3943;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;42;-2416.795,-618.3943;Inherit;False;Property;_Orange;Orange;5;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;51;-1936,-736;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;26;-2080,-624;Inherit;False;Property;_Yellow;Yellow;4;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;52;-1600,-736;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;53;-1264,-736;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GradientSampleNode;55;-848,-240;Inherit;True;2;0;OBJECT;;False;1;FLOAT;0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;19;-768,-304;Inherit;False;Property;_EmissiveIntensity;EmissiveIntensity;2;0;Create;True;0;0;0;False;0;False;20;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;18;-560,-304;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SmoothstepOpNode;32;-736,-64;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;31;-736,48;Inherit;False;Property;_OpacityPower;OpacityPower;12;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;30;-560,-16;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;-352,-192;Float;False;True;-1;2;Rendering.HighDefinition.HDUnlitGUI;0;13;M_MuzzleProjectile;7f5cb9c3ea6481f469fdd856555439ef;True;Forward Unlit;0;0;Forward Unlit;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Transparent=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;True;1;0;True;_SrcBlend;0;True;_DstBlend;1;0;True;_AlphaSrcBlend;0;True;_AlphaDstBlend;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;_CullModeForward;False;False;False;True;True;True;True;True;0;True;_ColorMaskTransparentVel;False;False;False;False;False;True;True;0;True;_StencilRef;255;False;;255;True;_StencilWriteMask;7;False;;3;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;0;True;_ZWrite;True;0;True;_ZTestDepthEqualForOpaque;False;True;1;LightMode=ForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;31;Surface Type;1;638337370782399131;  Rendering Pass ;0;0;  Rendering Pass;1;0;  Blending Mode;0;0;  Receive Fog;1;0;  Distortion;0;0;    Distortion Mode;0;0;    Distortion Only;1;0;  Depth Write;1;0;  Cull Mode;0;0;  Depth Test;4;0;Double-Sided;1;638337493759670147;Alpha Clipping;0;0;Receive Decals;1;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;Shadow Matte;0;0;Cast Shadows;1;0;DOTS Instancing;0;0;GPU Instancing;1;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;LOD CrossFade;0;0;0;8;True;True;True;True;True;True;False;True;False;;False;0
Node;AmplifyShaderEditor.RangedFloatNode;40;-1744,-624;Inherit;False;Property;_Green;Green;10;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;39;-1408,-624;Inherit;False;Property;_Cyan;Cyan;9;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GradientNode;35;-1472,-688;Inherit;False;0;3;2;0.06666666,0.3764706,0.1131507,0;0,0.6898999,0.6981132,0.6;0.05098039,0.9357048,1,1;1,0;1,1;0;1;OBJECT;0
Node;AmplifyShaderEditor.GradientNode;36;-1808,-688;Inherit;False;0;3;2;0.2053972,0.4716981,0,0;0.9339623,0.5719207,0,0.7058824;0.7571955,1,0,1;1,0;1,1;0;1;OBJECT;0
Node;AmplifyShaderEditor.GradientNode;29;-3824.795,-682.3943;Inherit;False;0;3;2;0,0.1704322,0.4627451,0;0.495283,0.8228605,1,0.2558785;1,1,1,1;1,0;1,1;0;1;OBJECT;0
Node;AmplifyShaderEditor.GradientNode;34;-3488.795,-682.3943;Inherit;False;0;3;2;0.2240418,0.1053756,0.6037736,0;0.252759,0.2867901,0.754717,0.4911726;1,0.2328192,0,1;1,0;1,1;0;1;OBJECT;0
Node;AmplifyShaderEditor.GradientNode;37;-3152.795,-682.3943;Inherit;False;0;4;2;0.4056604,0.1090691,0.371058,0;0.8,0,0.1336803,0.4352941;1,0.4103774,0.4438313,0.7088273;1,0.7161247,0.6367924,1;1,0;1,1;0;1;OBJECT;0
Node;AmplifyShaderEditor.GradientNode;45;-2144,-688;Inherit;False;0;3;2;0.8018868,0.5158336,0,0;0.8584906,0.6867926,0,0.3382315;1,0.999557,0.995283,0.997055;1,0;1,1;0;1;OBJECT;0
Node;AmplifyShaderEditor.GradientNode;27;-2480.795,-682.3943;Inherit;False;0;3;2;0.6792453,0.2197243,0,0;1,0.7731253,0,0.4911726;0.6736857,1,0.05098039,1;1,0;1,1;0;1;OBJECT;0
Node;AmplifyShaderEditor.GradientNode;60;-1056,-240;Inherit;False;0;3;2;0.2240418,0.1053756,0.6037736,0;0.252759,0.2867901,0.754717,0.4911726;1,0.2328192,0,1;1,0;1,1;0;1;OBJECT;0
Node;AmplifyShaderEditor.RangedFloatNode;33;-928,48;Inherit;False;Property;_OpacityCap;OpacityCap;13;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;61;-992,-176;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;62;-1344,-224;Inherit;False;Property;_ColorDarken;ColorDarken;14;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;8;-1344,-160;Inherit;True;Property;_PackTex;PackTex;0;0;Create;True;0;0;0;False;0;False;-1;bc1aeae3c2c4bf8499bd0ef6c52a0c25;bc1aeae3c2c4bf8499bd0ef6c52a0c25;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;15;-1728,-192;Inherit;False;Constant;_Float1;Float 1;1;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-1728,-128;Inherit;False;Constant;_Float2;Float 2;1;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;12;-1728,0;Inherit;False;Constant;_Float0;Float 0;1;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;17;-1728,-64;Inherit;False;Property;_Index;Index;1;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;9;-1584,-160;Inherit;False;Flipbook;-1;;1;53c2488c220f6564ca6c90721ee16673;2,71,0,68,0;8;51;SAMPLER2D;0.0;False;13;FLOAT2;0,0;False;4;FLOAT;3;False;5;FLOAT;3;False;24;FLOAT;0;False;2;FLOAT;0;False;55;FLOAT;0;False;70;FLOAT;0;False;5;COLOR;53;FLOAT2;0;FLOAT;47;FLOAT;48;FLOAT;62
WireConnection;46;1;29;0
WireConnection;46;2;28;0
...
WireConnection;61;1;8;3
WireConnection;8;1;9;0
WireConnection;9;4;15;0
WireConnection;9;5;16;0
WireConnection;9;24;17;0
WireConnection;9;2;12;0
ASEEND*/
//CHKSM=55B661603D3E3D558ECE188B2C3934C79F703A77