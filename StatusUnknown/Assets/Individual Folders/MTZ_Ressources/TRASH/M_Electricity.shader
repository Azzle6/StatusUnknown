	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				Gradient gradient60 = NewGradient( 0, 3, 2, float4( 0, 0.1704322, 0.4627451, 0 ), float4( 0.495283, 0.8228605, 1, 0.2558785 ), float4( 1, 1, 1, 1 ), 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				...
				float smoothstepResult32 = smoothstep( 0.0 , _OpacityCap , tex2DNode8.g);
				
				surfaceDescription.Color = ( _EmissiveIntensity * SampleGradient( gradient60, ( _ColorDarken * tex2DNode8.g ) ) ).rgb;
...
Node;AmplifyShaderEditor.GradientNode;60;-1056,-240;Inherit;False;0;3;2;0,0.1704322,0.4627451,0;0.495283,0.8228605,1,0.2558785;1,1,1,1;1,0;1,1;0;1;OBJECT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;15;-1728,-192;Inherit;False;Constant;_Float1;Float 1;1;0;Create;True;0;0;0;False;0;False;3;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-1728,-128;Inherit;False;Constant;_Float2;Float 2;1;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=AB0E10C2BA2E39A39C0FE9646E27BFA5CEF24DE9