	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				Gradient gradient60 = NewGradient( 0, 3, 2, float4( 0.6792453, 0.2197243, 0, 0 ), float4( 1, 0.7731253, 0, 0.4911726 ), float4( 0.6736857, 1, 0.05098039, 1 ), 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				float2 uv_PackTex = packedInput.ase_texcoord1.xy * _PackTex_ST.xy + _PackTex_ST.zw;
				float4 tex2DNode8 = tex2D( _PackTex, uv_PackTex );
				
				float smoothstepResult32 = smoothstep( 0.0 , _OpacityCap , tex2DNode8.a);
				
				surfaceDescription.Color = ( _EmissiveIntensity * SampleGradient( gradient60, ( _ColorDarken * tex2DNode8.a ) ) ).rgb;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 uv_PackTex = packedInput.ase_texcoord.xy * _PackTex_ST.xy + _PackTex_ST.zw;
				float4 tex2DNode8 = tex2D( _PackTex, uv_PackTex );
				float smoothstepResult32 = smoothstep( 0.0 , _OpacityCap , tex2DNode8.a);
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				Gradient gradient60 = NewGradient( 0, 3, 2, float4( 0.6792453, 0.2197243, 0, 0 ), float4( 1, 0.7731253, 0, 0.4911726 ), float4( 0.6736857, 1, 0.05098039, 1 ), 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				float2 uv_PackTex = packedInput.ase_texcoord2.xy * _PackTex_ST.xy + _PackTex_ST.zw;
				float4 tex2DNode8 = tex2D( _PackTex, uv_PackTex );
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 uv_PackTex = packedInput.ase_texcoord3.xy * _PackTex_ST.xy + _PackTex_ST.zw;
				float4 tex2DNode8 = tex2D( _PackTex, uv_PackTex );
				float smoothstepResult32 = smoothstep( 0.0 , _OpacityCap , tex2DNode8.a);
...
Node;AmplifyShaderEditor.RangedFloatNode;25;-1419.786,-924.7892;Inherit;False;Property;_MuzzleProjectile;Muzzle/Projectile;2;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;43;-3424.795,-618.3943;Inherit;False;Property;_Purple;Purple;5;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;28;-3760.795,-618.3943;Inherit;False;Property;_Blue;Blue;7;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;44;-3088.795,-618.3943;Inherit;False;Property;_Pink;Pink;6;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;41;-2752.795,-618.3943;Inherit;False;Property;_Red;Red;10;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;42;-2416.795,-618.3943;Inherit;False;Property;_Orange;Orange;4;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;51;-1936,-736;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;26;-2080,-624;Inherit;False;Property;_Yellow;Yellow;3;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;19;-768,-304;Inherit;False;Property;_EmissiveIntensity;EmissiveIntensity;1;0;Create;True;0;0;0;False;0;False;20;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GradientNode;60;-1056,-240;Inherit;False;0;3;2;0.6792453,0.2197243,0,0;1,0.7731253,0,0.4911726;0.6736857,1,0.05098039,1;1,0;1,1;0;1;OBJECT;0
Node;AmplifyShaderEditor.RangedFloatNode;33;-928,48;Inherit;False;Property;_OpacityCap;OpacityCap;12;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;62;-1344,-224;Inherit;False;Property;_ColorDarken;ColorDarken;13;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
WireConnection;61;1;8;4
ASEEND*/
//CHKSM=7175CDD4E8632CC4D6070918B4B6D336F37CA5F4