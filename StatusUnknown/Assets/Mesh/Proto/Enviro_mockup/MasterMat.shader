...
Shader "MasterMat"
{
	Properties
	{
		...
		_blockoutMaterials_Material_51_BaseMap("blockoutMaterials_Material _51_BaseMap", 2D) = "white" {}
		_blockoutMaterials_Material_51_MaskMap("blockoutMaterials_Material _51_MaskMap", 2D) = "white" {}
		_blockoutMaterials_Material_51_Normal("blockoutMaterials_Material _51_Normal", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _blockoutMaterials_Material_51_BaseMap_ST;
			float4 _blockoutMaterials_Material_51_Normal_ST;
			float4 _blockoutMaterials_Material_51_MaskMap_ST;
			...
			sampler2D _blockoutMaterials_Material_51_BaseMap;
			sampler2D _blockoutMaterials_Material_51_Normal;
			sampler2D _blockoutMaterials_Material_51_MaskMap;
						...
						)
			{
				...
				float2 uv_blockoutMaterials_Material_51_BaseMap = packedInput.ase_texcoord5.xy * _blockoutMaterials_Material_51_BaseMap_ST.xy + _blockoutMaterials_Material_51_BaseMap_ST.zw;
				
				float2 uv_blockoutMaterials_Material_51_Normal = packedInput.ase_texcoord5.xy * _blockoutMaterials_Material_51_Normal_ST.xy + _blockoutMaterials_Material_51_Normal_ST.zw;
				
				float2 uv_blockoutMaterials_Material_51_MaskMap = packedInput.ase_texcoord5.xy * _blockoutMaterials_Material_51_MaskMap_ST.xy + _blockoutMaterials_Material_51_MaskMap_ST.zw;
				float4 tex2DNode12 = tex2D( _blockoutMaterials_Material_51_MaskMap, uv_blockoutMaterials_Material_51_MaskMap );
				
				surfaceDescription.BaseColor = tex2D( _blockoutMaterials_Material_51_BaseMap, uv_blockoutMaterials_Material_51_BaseMap ).rgb;
				surfaceDescription.Normal = tex2D( _blockoutMaterials_Material_51_Normal, uv_blockoutMaterials_Material_51_Normal ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_blockoutMaterials_Material_51_BaseMap = packedInput.ase_texcoord2.xy * _blockoutMaterials_Material_51_BaseMap_ST.xy + _blockoutMaterials_Material_51_BaseMap_ST.zw;
				
				float2 uv_blockoutMaterials_Material_51_Normal = packedInput.ase_texcoord2.xy * _blockoutMaterials_Material_51_Normal_ST.xy + _blockoutMaterials_Material_51_Normal_ST.zw;
				
				float2 uv_blockoutMaterials_Material_51_MaskMap = packedInput.ase_texcoord2.xy * _blockoutMaterials_Material_51_MaskMap_ST.xy + _blockoutMaterials_Material_51_MaskMap_ST.zw;
				float4 tex2DNode12 = tex2D( _blockoutMaterials_Material_51_MaskMap, uv_blockoutMaterials_Material_51_MaskMap );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_blockoutMaterials_Material_51_Normal = packedInput.ase_texcoord3.xy * _blockoutMaterials_Material_51_Normal_ST.xy + _blockoutMaterials_Material_51_Normal_ST.zw;
				
				float2 uv_blockoutMaterials_Material_51_MaskMap = packedInput.ase_texcoord3.xy * _blockoutMaterials_Material_51_MaskMap_ST.xy + _blockoutMaterials_Material_51_MaskMap_ST.zw;
				float4 tex2DNode12 = tex2D( _blockoutMaterials_Material_51_MaskMap, uv_blockoutMaterials_Material_51_MaskMap );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_blockoutMaterials_Material_51_BaseMap = packedInput.ase_texcoord7.xy * _blockoutMaterials_Material_51_BaseMap_ST.xy + _blockoutMaterials_Material_51_BaseMap_ST.zw;
				
				float2 uv_blockoutMaterials_Material_51_Normal = packedInput.ase_texcoord7.xy * _blockoutMaterials_Material_51_Normal_ST.xy + _blockoutMaterials_Material_51_Normal_ST.zw;
				
				float2 uv_blockoutMaterials_Material_51_MaskMap = packedInput.ase_texcoord7.xy * _blockoutMaterials_Material_51_MaskMap_ST.xy + _blockoutMaterials_Material_51_MaskMap_ST.zw;
				float4 tex2DNode12 = tex2D( _blockoutMaterials_Material_51_MaskMap, uv_blockoutMaterials_Material_51_MaskMap );
...
Node;AmplifyShaderEditor.SamplerNode;11;-591,-75.5;Inherit;True;Property;_blockoutMaterials_Material_51_BaseMap;blockoutMaterials_Material _51_BaseMap;0;0;Create;True;0;0;0;False;0;False;-1;c38833e5ceb107547ac420d617003b29;c38833e5ceb107547ac420d617003b29;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;12;-592,110.5;Inherit;True;Property;_blockoutMaterials_Material_51_MaskMap;blockoutMaterials_Material _51_MaskMap;1;0;Create;True;0;0;0;False;0;False;-1;abfc0f87fa889ed439e9d1b91636b4b8;abfc0f87fa889ed439e9d1b91636b4b8;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;13;-592,295.5;Inherit;True;Property;_blockoutMaterials_Material_51_Normal;blockoutMaterials_Material _51_Normal;2;0;Create;True;0;0;0;False;0;False;-1;2b0857e1f48d2ee458868de9bc793eea;2b0857e1f48d2ee458868de9bc793eea;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=11D5D1A67E3401AE5AB7A6A8B5F76FE87B657877