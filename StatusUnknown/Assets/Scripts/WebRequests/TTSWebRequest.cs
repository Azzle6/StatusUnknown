...
public class TTSWebRequest : WebRequestBase
{
    ...
    private void Start()
    {
        ...
        if (useScriptableIfProvided && !string.IsNullOrEmpty(getResponseSO.ID))
        {
            ...
            OnGetRequestComplete(new UnityWebRequest()); 
            return; 
        }
    ...
    protected override void Populate_OnGetComplete(UnityWebRequest uwb) // = null when directly doign GET. But this default can be very dangerous.
    {
